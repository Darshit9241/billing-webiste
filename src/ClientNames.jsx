          ...
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6">
            ...
            <div className="flex items-center gap-2">
              ...
              {/* <select 
                ...
                className={`text-sm rounded-lg ${isDarkMode ? 'bg-white/5 text-white border-white/10' : 'bg-white text-gray-700 border-gray-200'} border p-1.5`}
        ...
        <div className="mb-6 space-y-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`w-full pl-10 pr-4 py-3 ${isDarkMode ? 'bg-white/5' : 'bg-white'} border ${isDarkMode ? 'border-white/10' : 'border-gray-200'} rounded-xl ${isDarkMode ? 'text-white placeholder-slate-400' : 'text-gray-900 placeholder-gray-400'} focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500 shadow-sm`}
            />
            {searchQuery && (
              <button
          ...
          <div className={`backdrop-blur-md ${isDarkMode ? 'bg-white/5' : 'bg-white'} rounded-xl border ${isDarkMode ? 'border-white/10' : 'border-gray-200'} shadow-md p-5`}>
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
              <div className={`${isDarkMode ? 'bg-white/5' : 'bg-gray-50'} rounded-xl p-4 border ${isDarkMode ? 'border-white/10' : 'border-gray-200'}`}>
                <p className={`text-sm ${isDarkMode ? 'text-slate-400' : 'text-gray-500'}`}>Total Clients</p>
                <p className={`text-2xl font-bold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>{clientsData.length}</p>
              </div>
              ...
              <div className={`${isDarkMode ? 'bg-white/5' : 'bg-gray-50'} rounded-xl p-4 border ${isDarkMode ? 'border-white/10' : 'border-gray-200'}`}>
                <p className={`text-sm ${isDarkMode ? 'text-slate-400' : 'text-gray-500'}`}>Total Value</p>
                <p className={`text-2xl font-bold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
              ...
              <div className={`${isDarkMode ? 'bg-white/5' : 'bg-gray-50'} rounded-xl p-4 border ${isDarkMode ? 'border-white/10' : 'border-gray-200'}`}>
                <p className={`text-sm ${isDarkMode ? 'text-slate-400' : 'text-gray-500'}`}>Pending Amount</p>
              ...
              <div className={`${isDarkMode ? 'bg-white/5' : 'bg-gray-50'} rounded-xl p-4 border ${isDarkMode ? 'border-white/10' : 'border-gray-200'}`}>
                <p className={`text-sm ${isDarkMode ? 'text-slate-400' : 'text-gray-500'}`}>Found</p>
                <p className={`text-2xl font-bold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
        ...
        {loading ? (
          <div className="flex flex-col justify-center items-center py-12">
            ...
            <div className="text-center">
              <p className="text-lg text-slate-300 font-medium mb-2">Loading clients...</p>
          ...
          <div className="text-center py-16 bg-white/5 rounded-xl border border-white/10 shadow-xl backdrop-blur-md">
            ...
            <h2 className="text-2xl font-semibold text-white mb-3">No clients found</h2>
                  ...
                  >
                    <div className="p-5">
                      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
                        <div>
                          <h3 className={`font-semibold text-lg md:text-xl ${isDarkMode ? 'text-white' : 'text-gray-900'} hover:text-emerald-500 transition-colors`}>
                            {client.clientName}
                          </h3>
                        ...
                        <div className="flex flex-wrap gap-3">
                          <div className={`${isDarkMode ? 'bg-white/5' : 'bg-gray-50'} rounded-lg py-1.5 px-3 border ${isDarkMode ? 'border-white/10' : 'border-gray-200'}`}>
                            <p className={`text-xs ${isDarkMode ? 'text-slate-400' : 'text-gray-500'}`}>Orders</p>
                            <p className={`font-medium text-center ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>{client.orderCount}</p>
                          </div>
                          
                          <div className={`${isDarkMode ? 'bg-white/5' : 'bg-gray-50'} rounded-lg py-1.5 px-3 border ${isDarkMode ? 'border-white/10' : 'border-gray-200'}`}>
                            <p className={`text-xs ${isDarkMode ? 'text-slate-400' : 'text-gray-500'}`}>Total Value</p>
                            <p className={`font-medium text-emerald-500`}>₹{client.totalAmount.toFixed(2)}</p>
                          </div>
                          
                          {client.pendingAmount > 0 && (
                            <div className={`${isDarkMode ? 'bg-amber-500/10' : 'bg-amber-50'} rounded-lg py-1.5 px-3 border ${isDarkMode ? 'border-amber-500/30' : 'border-amber-200'}`}>
                              <p className={`text-xs ${isDarkMode ? 'text-amber-300' : 'text-amber-600'}`}>Pending</p>
                              <p className={`font-medium text-amber-500`}>₹{client.pendingAmount.toFixed(2)}</p>
                            </div>
                          )}
                        </div>
                      </div>
                ...
                <div className="overflow-x-auto">
                  <table className="min-w-full divide-y divide-gray-700">
                    <thead className={isDarkMode ? 'bg-slate-800/50' : 'bg-gray-50'}>
                      <tr>
                        <th scope="col" className={`px-6 py-3 text-left text-xs font-medium ${isDarkMode ? 'text-slate-400' : 'text-gray-500'} uppercase tracking-wider`}>Client Name</th>
                        <th scope="col" className={`px-6 py-3 text-center text-xs font-medium ${isDarkMode ? 'text-slate-400' : 'text-gray-500'} uppercase tracking-wider`}>Orders</th>
                        <th scope="col" className={`px-6 py-3 text-center text-xs font-medium ${isDarkMode ? 'text-slate-400' : 'text-gray-500'} uppercase tracking-wider`}>Total Value</th>
                        <th scope="col" className={`px-6 py-3 text-center text-xs font-medium ${isDarkMode ? 'text-slate-400' : 'text-gray-500'} uppercase tracking-wider`}>Pending</th>
                        <th scope="col" className={`px-6 py-3 text-right text-xs font-medium ${isDarkMode ? 'text-slate-400' : 'text-gray-500'} uppercase tracking-wider`}>Last Order</th>
                      </tr>
                    </thead>
                    <tbody className={`divide-y ${isDarkMode ? 'divide-white/10' : 'divide-gray-200'}`}>
                      {paginatedClients.map((client, index) => (
                        ...
                        >
                          <td className={`px-6 py-4 whitespace-nowrap text-sm font-medium ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>{client.clientName}</td>
                          <td className={`px-6 py-4 whitespace-nowrap text-sm text-center ${isDarkMode ? 'text-slate-300' : 'text-gray-700'}`}>{client.orderCount}</td>
                          <td className={`px-6 py-4 whitespace-nowrap text-sm text-center text-emerald-500 font-medium`}>₹{client.totalAmount.toFixed(2)}</td>
                          <td className={`px-6 py-4 whitespace-nowrap text-sm text-center ${client.pendingAmount > 0 ? 'text-amber-500 font-medium' : (isDarkMode ? 'text-slate-500' : 'text-gray-500')}`}>
                            {client.pendingAmount > 0 ? `₹${client.pendingAmount.toFixed(2)}` : '-'}
                          </td>
                          <td className={`px-6 py-4 whitespace-nowrap text-sm text-right ${isDarkMode ? 'text-slate-400' : 'text-gray-500'}`}>{formatDate(client.lastOrderDate)}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
